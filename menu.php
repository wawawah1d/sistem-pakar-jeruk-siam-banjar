...
<li><a <?php if ($module == "") echo 'class="active"'; ?> href="./"><i class="fa fa-home"></i> <span>Beranda</span></a><li>
  ...
  if (isset($_SESSION['username']) && isset($_SESSION['password'])) {
    ...
    <li><a <?php if ($module == "admin") echo 'class="active"'; ?> href="admin"><i class="fa fa-user"></i> <span>Admin</span></a><li>
      <div class="container"></div>	
    <li><a <?php if ($module == "penyakit") echo 'class="active"'; ?> href="penyakit"><i class="fa fa-bug"></i> <span>Hama dan Penyakit</span></a><li>
      <div class="container"></div>	
    ...
    <li><a <?php if ($module == "pengetahuan") echo 'class="active"'; ?> href="pengetahuan"><i class="fa fa-flask"></i> <span>Pengetahuan</span></a><li>
      <div class="container"></div>
    <li><a <?php if ($module == "post") echo 'class="active"'; ?> href="post"><i class="fa fa-file-text"></i> <span>Post Informasi</span></a><li>
      <div class="container"></div>
    <li class="treeview">
                    <a href="#">
                    ...
                    <li><a <?php if ($module == "laporan") echo 'class="active"'; ?> href="laporan"><i class="fa fa-commenting-o"></i> <span>Laporan Konsultasi</span></a><li>
                    <div class="container"></div>
                    <li><a <?php if ($module == "laporang") echo 'class="active"'; ?> href="laporang"><i class="fa fa-commenting-o"></i> <span>Laporan Gejala</span></a><li>
                    <div class="container"></div>
                    <li><a <?php if ($module == "laporanh") echo 'class="active"'; ?> href="laporanh"><i class="fa fa-commenting-o"></i> <span>Laporan Penyakit</span></a><li>
                    <div class="container"></div>
    ...
    <li><a <?php if ($module == "riwayat") echo 'class="active"'; ?> href="riwayat"><i class="fa fa-clock-o"></i> <span>Riwayat</span></a><li>
      <div class="container"></div>
    <li><a <?php if ($module == "keterangan") echo 'class="active"'; ?> href="keterangan"><i class="fa fa-file-text"></i> <span>Informasi Hama dan Penyakit</span></a><li>
      <div class="container"></div>
    <?php  
  }
  ?>