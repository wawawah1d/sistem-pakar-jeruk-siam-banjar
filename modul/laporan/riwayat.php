...
//jumlah data yang ditampilkan perpage
        ...
        if ($baris > 0) {
            ...
            <h2 class='text text-primary'>Laporan Hasil Konsultasi &nbsp;&nbsp;
            <button id='print' onClick='window.print();' data-toggle='tooltip' data-placement='right' title='Klik tombol ini untuk mencetak hasil diagnosa'><i class='fa fa-print no-print'></i> Cetak</button> </h2>
            <thead>
            <tr>
              <th>No</th>
              <th>Tanggal</th>
