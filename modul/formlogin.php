...
<head>
  <meta charset="UTF-8">
  <title>Login Pakar - SiBANJAR</title>
...
<input type="submit" name="submit" id="submitku" value="   Login   " /><br>
 <p class="message">Ingin mendaftar? <a href="https://forms.gle/xTGva3yYJpjZfL9H8" target="_blank">Ajukan Permohonan</a></p>
  </form>
</div>
</body>
...
<script>
var d = document.getElementById("pakarjeruk");
